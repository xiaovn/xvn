...
Class tkbModel extends baseModel
{
    ...
    {
        global $db;
        $db->query("SELECT mon FROM xdata_tkb WHERE thu= ".$thu." AND tiet=".$tiet." AND buoi=".$buoi." AND malop=".$malop." AND nhommon=".$nhommon);
    ...
    {
        global $db;
        $db->query("SELECT * FROM xdata_tkb WHERE malop=".$malop);
