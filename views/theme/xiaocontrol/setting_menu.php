...
<ul class="topnav pull-right hidden-phone hidden-tablet hidden-desktop-1">
    ...
    <li class="hidden-tablet hidden-phone hidden-desktop-1 dropdown dd-1 dd-flags" id="lang_nav">
        <a href="#" data-toggle="dropdown"><img src="<?php echo $admintemplate_path;?>/asset/images/vn.png" alt="en" /></a>
        <ul class="dropdown-menu pull-left">
            <li><a href="?lang=en" title="English"><img src="<?php echo $admintemplate_path;?>/asset/images/en.png" alt="English"> English</a></li>
            <li class="active"><a href="/?lang=vn" title="Tiếng Việt"><img src="<?php echo $admintemplate_path;?>/asset/images/vn.png" alt="Tiếng Việt"> Tiếng Việt</a></li>
    ...
    <li class="account dropdown dd-1">
        ...
        <ul class="dropdown-menu pull-right">
            <li><a href="#" class="glyphicons cogwheel">Thiết lập<i></i></a></li>
            <li><a href="#" class="glyphicons camera">Nhật ký hệ thống<i></i></a></li>
            <li class="profile">
							<span>
								<span class="heading">Thông tin <a href="<?php echo XC_URL?>/admin/myaccount/?view=edit" class="pull-right">sửa</a></span>
								<span class="img"></span>
								<span class="details">
