...
<h2>Quản lý thời khóa biểu <span>nhập thời khóa biểu</span></h2>
<div class="innerLR">
...
<div class="widget-head">
    <h4 class="heading glyphicons list"><i></i> Nhập thời khóa biểu theo file</h4>
</div>
<!-- // Widget heading END -->

<div class="widget-body">
    <p>Chức năng nhập thời khóa biểu bằng file excel cho phép thầy/cô nhập thời khóa biểu mà không cần qua xử lý file, điều này rất phù hợp với việc nhà trường đang sử dụng hệ thống quản lý TKB bằng EXCEL, tuy nhiên, VES khuyến cáo thầy/cô hoặc cán bộ quản lý nên sử dụng phần mềm quản lý điểm của Xiao (hoàn toàn miễn phí) với những tính năng vượt trội (<a href="http://xiao.vn">chi tiết</a>).</p>
</div>
</div>
<div class="row-fluid">
    <div class="span6">
        <form action="<?php echo XC_URL?>/admin/process/?action=importtkb" method="POST" enctype="multipart/form-data" name="frmnhaptkb">
                ...
                <div class="widget-body">
                   <div class="row-fluid">
                        <div class="span6">
                            <h5>Chọn nhóm môn</h5>
                            <div class="row-fluid">
                                <?php $listsj = school::getInstance()->dsnhommon();?>
                                <select name="isubject" style="width: 100%;" id="select2_1">
                                    <optgroup label="Chọn môn">
                                        <?php foreach($listsj as $subj)
                                        {
                                            ?>
                                            <option value="<?php echo $subj->manhommon;?>"><?php echo $subj->tennhommon?></option>
                                            <?php
                                        }?>
                                    </optgroup>
                                </select>
