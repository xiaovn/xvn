...
tl.pg.PageGuide.prototype.open = function() {
    ...
    this.track_event('http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/plugins/other/pageguide/js/PG.open');
...
tl.pg.PageGuide.prototype.setup_handlers = function () {
    ...
    this.$fwd.live('click', function() {
        ...
        that.track_event('http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/plugins/other/pageguide/js/PG.fwd');
        that.show_message(new_index);
        return false;
    });
    ...
    this.$back.live('click', function() {
        ...
        that.track_event('http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/plugins/other/pageguide/js/PG.back');
