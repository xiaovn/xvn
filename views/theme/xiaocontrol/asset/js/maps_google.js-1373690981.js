...
$(function()
{
	...
	if ($('#google-map-filters').length)
	{
		...
		$('#google-map-filters').gmap({'disableDefaultUI':true}).bind('init', function(evt, map) { 
			...
			var lngSpan = northEast.lng() - southWest.lng();
			var latSpan = northEast.lat() - southWest.lat();
			var images = ['friends.png'/*tpa=http://google-maps-icons.googlecode.com/files/friends.png*/, 'home.png'/*tpa=http://google-maps-icons.googlecode.com/files/home.png*/, 'girlfriend.png'/*tpa=http://google-maps-icons.googlecode.com/files/girlfriend.png*/, 'dates.png'/*tpa=http://google-maps-icons.googlecode.com/files/dates.png*/, 'realestate.png'/*tpa=http://google-maps-icons.googlecode.com/files/realestate.png*/, 'apartment.png'/*tpa=http://google-maps-icons.googlecode.com/files/apartment.png*/, 'family.png'/*tpa=http://google-maps-icons.googlecode.com/files/family.png*/];
	...
	if ($('#google-map-streetview').length)
	{
		$('#google-map-streetview').gmap({ 'disableDefaultUI':true, 'callback': function() {
			...
			self.microformat('.vevent', function(result, item, index) {
				...
				self.addMarker( { 'bounds':true, 'position': latlng, 'title': result.summary, 'icon': 'music-rock.png'/*tpa=http://google-maps-icons.googlecode.com/files/music-rock.png*/ }, function(map, marker) {
