		...
		data: 
		{
			...
			tableReffering:
			{
				...
				init: function()
				{
					...
					data.addRows(6);
					data.setCell(0, 0, 'http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/demo/google.ro');
					...
					data.setCell(1, 0, 'http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/demo/search.sweetim.com');
					...
					data.setCell(2, 0, 'http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/demo/start.funmoods.com');
					...
					data.setCell(3, 0, 'http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/demo/google.md');
					...
					data.setCell(4, 0, 'http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/demo/searchmobileonline.com');
					data.setCell(4, 1, 2, null, {'style': 'text-align: center;'});
					data.setCell(4, 2, '00:02:21', null, {'style': 'text-align: center;'});
					data.setCell(4, 3, '1', null, {'style': 'text-align: center;'});
					data.setCell(5, 0, 'http://demo.mosaicpro.biz/quickadmin/common/theme/scripts/demo/google.com');
