...
var bootstrapWizardCreate = function(element, options) {
	...
	this.fixNavigationButtons = function() {
		...
		if(obj.currentIndex() >= obj.navigationLength()) {
			$('http://demo.mosaicpro.biz/quickadmin/common/bootstrap/extend/twitter-bootstrap-wizard/li.next', element).addClass('disabled');
		} else {
			$('http://demo.mosaicpro.biz/quickadmin/common/bootstrap/extend/twitter-bootstrap-wizard/li.next', element).removeClass('disabled');
		}
