<?php 
	...
	*/
	 ...
	 */
	define('DB_USERTABLE','account'); 
	define('DB_USERTABLE_NAME','username'); 
	define('DB_USERTABLE_USERID','xid'); 
	define('DB_USERTABLE_AVATAR','avatar'); 
	
	define('DB_FRIENDSTABLE','friend'); 
	define('DB_FRIENDSTABLE_USERID', 'xid1'); 
	define('DB_FRIENDSTABLE_FRIENDID', 'xid2'); 
